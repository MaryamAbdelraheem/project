...
function General() {
  ...
  const filterByTypeAndCategory = (products) => {
    return products.filter(item => item.type === 'course' && item.category === 'general');
  };
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'cs'} onChange={toggleSubCategory} /> CS
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'is'} onChange={toggleSubCategory} /> IS
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'it'} onChange={toggleSubCategory} /> IT
            </p>
          </div>
        </div>
